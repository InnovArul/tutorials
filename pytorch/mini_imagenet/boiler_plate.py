...
train_data_dir = './data/4/train' # put path of training dataset
val_data_dir = './data/4/val' # put path of validation dataset
test_data_dir = './data/4/test' # put path of test dataset
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv4 = nn.Conv2d(in_channels=256, out_channels=512, kernel_size=3)
        self.conv5 = nn.Conv2d(in_channels=512, out_channels=768, kernel_size=3)
